...
import { ArrowLeft, Filter, ExternalLink, Heart, Clock, Info, Tag, CreditCard } from 'lucide-react';
...
const ResultsPage = () => {
  ...
  const handlePlatformRedirect = (platform: string, item: any) => {
          ...
          <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden transform transition hover:shadow-lg">
            ...
            <div className="lg:hidden bg-gray-50 p-3 grid grid-cols-2 gap-3 border-t border-gray-100">
              <div className="text-center">
                ...
                <div className="font-bold">₹{item.zomato.finalPrice}</div>
              </div>
              <div className="text-center">
                <span className="text-sm font-medium">Swiggy</span>
                <div className="font-bold">₹{item.swiggy.finalPrice}</div>
              </div>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      <tr className="border-b">
                        ...
                        <td className="text-right py-2">₹{results[selectedInfoIndex].zomato.basePrice}</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].swiggy.basePrice}</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2">Discount</td>
                        <td className="text-right py-2">{results[selectedInfoIndex].zomato.discount}%</td>
                        <td className="text-right py-2">{results[selectedInfoIndex].swiggy.discount}%</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2">Delivery Fee</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].zomato.deliveryFee}</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].swiggy.deliveryFee}</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2">Taxes</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].zomato.taxes}</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].swiggy.taxes}</td>
                      </tr>
                      <tr className="border-b">
                      ...
                      <tr className="border-b font-semibold">
                        ...
                        <td className="text-right py-2">₹{results[selectedInfoIndex].zomato.finalPrice}</td>
                        <td className="text-right py-2">₹{results[selectedInfoIndex].swiggy.finalPrice}</td>
                      </tr>
                      <tr>
                        <td className="py-2">Delivery Time</td>
                        <td className="text-right py-2">{results[selectedInfoIndex].zomato.deliveryTime} mins</td>
                        <td className="text-right py-2">{results[selectedInfoIndex].swiggy.deliveryTime} mins</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
